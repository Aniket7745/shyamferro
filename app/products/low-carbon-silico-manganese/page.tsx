...
export default function LowCarbonSilicoManganesePage() {
  ...
  return (
    <main className="bg-white text-black dark:bg-black dark:text-white overflow-hidden transition-colors duration-300">
      ...
      <section className="relative h-[90vh] flex flex-col justify-center items-center text-center">
        <Image
          src="/products/lc-silico-manganese.jpg"
          alt="Low Carbon Silico Manganese"
          fill
        ...
        >
          <h1 className="text-6xl md:text-7xl font-bold mb-4">
            Low Carbon <span style={{ color: orange }}>Silico Manganese</span>
          </h1>

          <h2 className="text-2xl md:text-3xl text-gray-700 dark:text-gray-200 font-medium mb-8">
            Low-carbon precision for high-end steelmaking
          </h2>

          <p className="text-gray-700 dark:text-gray-300 text-lg md:text-xl leading-relaxed mx-auto max-w-3xl">
            Ideal for advanced alloy steels requiring strict low-carbon control. It offers the benefits of Silico Manganese while minimizing carbon pickup.
          </p>
        </motion.div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8">
              Low Carbon Silico Manganese is crucial for producing low-carbon steel grades, including stainless steel and special alloy steels. It ensures high purity and superior mechanical properties.
            </p>

            <ul className="space-y-3 text-gray-700 dark:text-gray-300 text-base mb-8">
              <li>• Extremely low carbon content</li>
              <li>• High manganese and silicon recovery</li>
              <li>• Ideal for stainless steel production</li>
              <li>• Reduces refining costs</li>
              <li>• Superior cleanliness in steel</li>
            </ul>

            <Link
              href="/enquiry?product=Low Carbon Silico Manganese"
          ...
          >
            <Image
              src="/products/LowCarbonSilicoManganese.jpg"
              alt="Low Carbon Silico Manganese"
              fill
