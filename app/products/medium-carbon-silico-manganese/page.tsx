...
export default function MediumCarbonSilicoManganesePage() {
  ...
  return (
    <main className="bg-white text-black dark:bg-black dark:text-white overflow-hidden transition-colors duration-300">
      ...
      <section className="relative h-[90vh] flex flex-col justify-center items-center text-center">
        <Image
          src="/products/mc-silico-manganese.jpg"
          alt="Medium Carbon Silico Manganese"
          fill
        ...
        >
          <h1 className="text-6xl md:text-7xl font-bold mb-4">
            Medium Carbon <span style={{ color: orange }}>Silico Manganese</span>
          </h1>

          <h2 className="text-2xl md:text-3xl text-gray-700 dark:text-gray-200 font-medium mb-8">
            Balanced chemistry. Uniform steel structure.
          </h2>

          <p className="text-gray-700 dark:text-gray-300 text-lg md:text-xl leading-relaxed mx-auto max-w-3xl">
            Provides controlled composition and stable mechanical properties. Ideal for steel grades requiring precise carbon control without compromising on deoxidation.
          </p>
        </motion.div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8">
              Medium Carbon Silico Manganese bridges the gap between high and low carbon alloys, offering a balanced solution for specialized steel manufacturing.
            </p>

            <ul className="space-y-3 text-gray-700 dark:text-gray-300 text-base mb-8">
              <li>• Balanced carbon content</li>
              <li>• Excellent deoxidizing capability</li>
              <li>• Improves steel homogeneity</li>
              <li>• Suitable for specialized alloy steels</li>
              <li>• Reduces refining time</li>
            </ul>

            <Link
              href="/enquiry?product=Medium Carbon Silico Manganese"
          ...
          >
            <Image
              src="/products/MediumCarbonSilicoManganese.png"
              alt="Medium Carbon Silico Manganese"
              fill
