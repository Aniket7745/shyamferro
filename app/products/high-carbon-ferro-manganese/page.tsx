...
export default function HighCarbonFerroManganesePage() {
      ...
      <section className="relative h-[90vh] flex flex-col justify-center items-center text-center">
        ...
        >
          <h1 className="text-6xl md:text-7xl font-bold mb-4">
            High Carbon <span style={{ color: orange }}>Ferro Manganese</span>
          </h1>

          <h2 className="text-2xl md:text-3xl text-gray-700 dark:text-gray-200 font-medium mb-8">
            Essential Alloying Material for High-Strength Steel
          </h2>

          <p className="text-gray-700 dark:text-gray-300 text-lg md:text-xl leading-relaxed mx-auto max-w-3xl">
            High Carbon Ferro Manganese is widely used in steel manufacturing
            for its strong deoxidizing and desulfurizing properties, ensuring
            durability, strength, and improved metallurgical quality.
          </p>
        </motion.div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl font-bold mb-6" style={{ color: orange }}>
              Built for Stronger Steel
            </h2>
            <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8">
              High Carbon Ferro Manganese plays a critical role in steel
              production, enhancing hardness, strength, and resistance to wear.
              It acts as a cost-effective deoxidizer and alloying component in
              various grades of steel.
            </p>

            <ul className="space-y-3 text-gray-700 dark:text-gray-300 text-base mb-8">
              <li>• Improves steel strength & durability</li>
              <li>• Effective deoxidizing and desulfurizing agent</li>
              <li>• High metallurgical recovery</li>
              <li>• Available in multiple grade compositions</li>
              <li>• Controlled carbon for consistent quality</li>
            </ul>

            <Link
              href="/enquiry?product=High Carbon Ferro Manganese"
      ...
      <section className="py-20 bg-white dark:bg-black border-t border-gray-200 dark:border-neutral-800 transition-colors">
        <div className="max-w-6xl mx-auto px-6">
          <h2
            ...
            style={{ color: orange }}
          >
            Chemical Composition (Grades I–IV)
          </h2>
